...
public class daoContacto {
    ...
    String tabla = "create table if not exists contacto(id integer primary key autoincrement, nombre text, apellido text, email text, email text, telefono text, ciudad text)";
